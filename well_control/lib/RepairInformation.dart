...
class _RepairInformationState extends State<RepairInformation> {
  ...
  Widget build(BuildContext context) {
    ...
    Image(image: AssetImage('assets/repair-info/quick-fix-pressure-switch.jpg'));
    return MaterialApp(
        home: Scaffold(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            const ListTile(
                              ...
                              subtitle: Text('You’ll find the pressure switch mounted on a 1/4-in. tube near the pressure tank. '
                            ...
                            Card(
                              child: Column(
                                ...
                                children: <Widget>[
                                  const ListTile(
                                    leading: Icon(Icons.album),
                                    title: Text('Step 2: If the switch is bad, replace it.'),
                                    subtitle: Text('If you find the pressure switch is bad, test the pressure tank '
                            ...
                            Card(
                              child: Column(
                                ...
                                children: <Widget>[
                                  const ListTile(
                                    leading: Icon(Icons.album),
                                    title: Text('If you can\'t replace it: Temporary quick fix'),
                                    subtitle: Text('If banging on the tube under the pressure switch kicked on the well pump, it'
